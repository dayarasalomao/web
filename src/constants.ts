export const CONTACT_NUMBER = '(41) 3123-6550'
export const CONTACT_EMAIL = 'dradayarasalomao@gmail.com'
export const CONTACT_ADDRESS = 'Rua Góias, 70 - Água Verde, Curitiba, Paraná'
export const CONTACT_HOURS = 'Segunda a Sexta-feira, das 8h às 18h'
